...
describe('sdminService', () => {
  describe('positive', () => {
    test('should contain the expected functions', () => {
      ...
      // Act
      isGetStatusFuncValid =
        typeof adminService.getStatus !== 'undefined' &&
        typeof adminService.getStatus === 'function';

      isHasStatusFuncValid =
        typeof adminService.hasStatus !== 'undefined' &&
        typeof adminService.hasStatus === 'function';
