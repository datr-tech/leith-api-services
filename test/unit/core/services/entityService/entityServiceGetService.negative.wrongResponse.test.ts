...
/**
 * entityServiceGetService.negative.wrongResponse
 *
...
describe('entityServiceGetService', () => {
  ...
  describe('negative.wrongResponse', () => {
    ...
    beforeAll(() => {
      ...
      /*
       * Mock a single 200 service response from
       * the generated url with 'unknownField',
       * rather than the expected 'service' field.
       */
     ...
     * PERFORM TEST
     */
    test("should return the expected error when the 'service' field can not be found", async () => {
      /*
       * Arrange
       */
      const serviceId = id;
